# cache-login-appshell-sw - Work Plan
...
- Evidence: .omo/evidence/task-<N>-cache-login-appshell-sw.<ext>
...
- [ ] 1. <title>
  ...
  QA scenarios (name the exact tool + invocation): happy + failure, Evidence .omo/evidence/task-1-cache-login-appshell-sw.<ext>
